========================================================================
       MICROSOFT FOUNDATION CLASS ライブラリ : ViewPractice
========================================================================


AppWizard が生成した ViewPractice には、Microsoft Foundation Class の基本的な
使い方が示されています。アプリケーション作成のひな型としてお使いください。

このファイルには ViewPractice を構成している各ファイルの概要説明が含まれています。
...
ViewPractice.h
    ...
    みます） をインクルードし、また CViewPracticeApp アプリケーションクラスを宣
    言します。

ViewPractice.cpp
    このファイルは CViewPracticeApp アプリケーションクラスを含むアプリケーション
    の中心となるソースファイルです。
...
res\ViewPractice.ico
    このファイルは、アプリケーションのアイコンとして使用されるアイコンファイ
    ルです。このアイコンはリソース ファイル ViewPractice.rc によってインクルード
    されます。

res\ViewPractice.rc2
...
res\Toolbar.bmp
    ...
    リソースエディタで編集し、ViewPractice.rc ファイル内の IDR_MAINFRAME TOOLBAR 配列を
    変更してください。
/////////////////////////////////////////////////////////////////////////////
...
ViewPracticeDoc.h, ViewPracticeDoc.cpp - ドキュメント
    これらのファイルは CViewPracticeDoc クラスを含みます。特別なドキュメント デ
    ータを付け加えたり、CViewPracticeDoc::Serialize を使ったファイルのセーブや
    ロード機能をインプリメントしたいときはこのファイルを編集してください。

ViewPracticeView.h, ViewPracticeView.cpp - ビュー
    これらのファイルは CViewPracticeView クラスを含みます。
    CViewPracticeView オブジェクトは CViewPracticeDoc オブジェクトを表示するために
    使います。
res\ViewPracticeDoc.ico
    このファイルは CViewPracticeDoc クラスの MDI 子ウィンドウ用アイコンとして使
    われるアイコンファイルです。このアイコンはリソースファイル ViewPractice.rc
    によってインクルードされます。
...
StdAfx.h, StdAfx.cpp
    これらのファイルはプリコンパイル済ヘッダー ファイル (PCH) ViewPractice.pch 
