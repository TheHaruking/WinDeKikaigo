========================================================================
       MICROSOFT FOUNDATION CLASS ライブラリ : SplitterPractice
========================================================================


AppWizard が生成した SplitterPractice には、Microsoft Foundation Class の基本的な
使い方が示されています。アプリケーション作成のひな型としてお使いください。

このファイルには SplitterPractice を構成している各ファイルの概要説明が含まれています。

SplitterPractice.dsp
...
SplitterPractice.h
    ...
    みます） をインクルードし、また CSplitterPracticeApp アプリケーションクラスを宣
    言します。

SplitterPractice.cpp
    このファイルは CSplitterPracticeApp アプリケーションクラスを含むアプリケーション
    の中心となるソースファイルです。
...
res\SplitterPractice.ico
    このファイルは、アプリケーションのアイコンとして使用されるアイコンファイ
    ルです。このアイコンはリソース ファイル SplitterPractice.rc によってインクルード
    されます。

res\SplitterPractice.rc2
...
res\Toolbar.bmp
    ...
    リソースエディタで編集し、SplitterPractice.rc ファイル内の IDR_MAINFRAME TOOLBAR 配列を
    変更してください。
/////////////////////////////////////////////////////////////////////////////

AppWizard は 1 つのドキュメントタイプと 1 つのビューを作成します。

SplitterPracticeDoc.h, SplitterPracticeDoc.cpp - ドキュメント
    これらのファイルは CSplitterPracticeDoc クラスを含みます。特別なドキュメント デ
    ータを付け加えたり、CSplitterPracticeDoc::Serialize を使ったファイルのセーブや
    ロード機能をインプリメントしたいときはこのファイルを編集してください。

SplitterPracticeView.h, SplitterPracticeView.cpp - ビュー
    これらのファイルは CSplitterPracticeView クラスを含みます。
    CSplitterPracticeView オブジェクトは CSplitterPracticeDoc オブジェクトを表示するために
    使います。
...
StdAfx.h, StdAfx.cpp
    これらのファイルはプリコンパイル済ヘッダー ファイル (PCH) SplitterPractice.pch 
